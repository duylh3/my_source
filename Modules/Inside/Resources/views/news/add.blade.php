                    ...
                    <div class="tab-content">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="form-field-1">
                                ...
                                {!! Form::text("title", null, ['class' => 'form-control','id' => "editor1"]) !!}
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="form-field-1">
                                ...
                                {!! Form::text("define", null, ['class' => 'form-control','id' => "editor1"]) !!}
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="form-field-1">
                                ...
                                {!! Form::text("time", null, ['class' => 'form-control','id' => "editor1"]) !!}
