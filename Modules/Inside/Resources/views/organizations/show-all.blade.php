...
<?php
$searchOptions = array(
    'organization_name_search' => 'Tiêu đề',
);
?>
<style>
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            <th>
                                <div class="th-inner">
                                    Tên VPCC
                                    {{ DisplayColumnSort::show('organization_name') }}
                                </div>
                            </th>
                            <th>
                                <div class="th-inner">
                            ...
                            <th>
                                <div class="th-inner">
                                    Điện thoại
                                    {{ DisplayColumnSort::show('phone') }}
                                </div>
                            </th>
                            <th>
                                <div class="th-inner">
                                    Địa chỉ
                                    {{ DisplayColumnSort::show('address') }}
                                </div>
                            </th>
                            <th>
                                <div class="th-inner">
                                    Địa chỉ
                                    {{ DisplayColumnSort::show('email') }}
                                </div>
                            </th>
                            <th>
                                <div class="th-inner">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a  href="{!! url("inside/{$controllerName}/edit/{$row->organization_id}"); !!}"
                                ...
                                <a  href="{!! url("/{$controllerName}/delete/{$row->organization_id}"); !!}"
