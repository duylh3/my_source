...
class EntrustGroup extends DbTable
{
     ...
     * @return mixed
     * @author Nhan Nguyen
     * get relationship with Role
     */

    public function roles(){
        return $this->belongsToMany(Config::get('entrust.role'),Config::get('entrust.group_role_table'), Config::get('entrust.group_foreign_key'), Config::get('entrust.role_foreign_key'));
    }
