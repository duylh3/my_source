...
trait MyEntrustRoleTrait
{
    ...
    public function groups(){
        return $this->belongsToMany(Config::get('entrust.role'), Config::get('entrust.group_role_table'),Config::get('entrust.role_foreign_key'),Config::get('entrust.group_foreign_key'));
    }
    /**
